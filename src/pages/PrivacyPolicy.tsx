        ...
        <article className="prose prose-neutral dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-1">
              ...
              <li><strong>Ask PepSA minimisation:</strong> Our database stores the selected compound and request time for rate limiting, not the raw question. Calculator values are sent only when your question asks to explain that measurement.</li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-1">
              ...
              <li><strong>Ask PepSA:</strong> Questions are processed inside our authenticated Supabase function from the selected source packet. Raw questions and calculator values are not sent to an external AI provider.</li>
            </ul>
          </section>
