import { sendEmail, isEmailConfigured, emailProviderName } from '../_shared/email.ts'
...
// EmailSendError carries the upstream status; older/unknown errors fall back
// to parsing the message.
