...
// SSE streaming). The Supabase gateway still requires a valid project token,
// preventing unrestricted anonymous traffic to the function.
//
// Data: the MCP uses a deliberately minimal public research index. Personal
// dosing, supplier, stock, price and certificate data stay out of this API.
...
function createServer(): McpServer {
  ...
  server.registerTool(
    "get_peptide",
    {
      ...
      description:
        "Return a concise educational research profile for one peptide, without personal dosing or supplier data.",
      inputSchema: {
        id: z
          .string()
          .trim()
    ...
    ({ id }) => {
      ...
      const summary = [
        ...
        "",
        "Educational research index only. Regulatory status varies; consult a qualified clinician.",
      ]
        .filter(Boolean)
        .join("\n");
      return {
