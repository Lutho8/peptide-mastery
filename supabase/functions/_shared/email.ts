...
//   EMAIL_PROVIDER   "resend" | "none"   (default: "resend")
//   RESEND_API_KEY   required when EMAIL_PROVIDER=resend
//   EMAIL_FROM       fallback From address when a payload omits one
//
// EMAIL_PROVIDER=none is an explicit local-development mode. Production fails
// closed when RESEND_API_KEY is absent: queued messages remain retryable rather
// than being marked as sent and silently discarded.
